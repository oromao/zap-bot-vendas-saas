...
const platforms = [
  {
    name: "Nuvemshop",
    logo: "https://cdn3.freelogovectors.net/wp-content/uploads/2022/03/nuvemshop-logo-freelogovectors.net_.png",
  },
  {
    name: "WooCommerce",
  ...
  {
    name: "Tray",
    logo: "https://149368500.v2.pressablecdn.com/wp-content/uploads/2022/10/2022-marketplace-pressroom-tray-logo-12_og.jpg",
  },
  {
    name: "Shopify",
    logo: "https://1000logos.net/wp-content/uploads/2023/01/Shopify-logo-500x281.jpg",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="bg-white p-3 rounded-lg flex-1 border">
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                      Conectado com +55 (11) 98765-4321
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="bg-white p-3 rounded-lg flex-1 border">
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                      Conectado com Moda Express Store
                    </div>
                  </div>
                </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 mb-6">
              Conecte sua loja em minutos com nosso sistema de integração
              simplificado. Compatível com as principais plataformas de
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-4">
                {platforms.map((platform, index) => (
                  <div
                    key={index}
                    className="bg-white border rounded-md p-2 flex items-center gap-2 w-36"
                  >
